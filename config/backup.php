...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                /*
                 * DB-only backup — no application files included.
                 * Add paths here if you want to back up uploaded files too.
                 */
                'include' => [],
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'zaoadonaiel@gmail.com'),
