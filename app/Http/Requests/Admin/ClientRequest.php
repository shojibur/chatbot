...
abstract class ClientRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'lead_sms_to' => [
                Rule::requiredIf(fn () => (bool) $this->boolean('lead_sms_enabled')),
                'nullable',
                'string',
                'max:32',
                'regex:/^\+[1-9]\d{7,14}$/',
            ...
            'chatbot_tone' => ['nullable', 'string', 'max:500'],
            'engagement_questions' => ['nullable', 'string', 'max:2000'],
            'expert_name' => ['nullable', 'string', 'max:255'],
            'expert_title' => ['nullable', 'string', 'max:255'],
            'expert_followup' => ['nullable', 'string', 'max:500'],
