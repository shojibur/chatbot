...
class ClientController extends Controller
{
    ...
    private function payload(StoreClientRequest|UpdateClientRequest $request): array
    {
        ...
        $leadCaptureIntroMessage = trim((string) ($validated['lead_capture_intro_message']
            ?? ($existingWidgetSettings['lead_capture_intro_message'] ?? self::DEFAULT_LEAD_CAPTURE_INTRO_MESSAGE)));
        ...
        return [
            ...
            'lead_capture_enabled' => (bool) $validated['lead_capture_enabled'],
            'lead_sms_enabled' => (bool) $validated['lead_sms_enabled'],
            'lead_sms_to' => $validated['lead_sms_to'],
            'website_url' => $validated['website_url'],
            'business_description' => $validated['business_description'],
            'system_prompt' => $validated['system_prompt'],
            'chatbot_tone' => $validated['chatbot_tone'],
            'engagement_questions' => $validated['engagement_questions'],
            'expert_name' => $validated['expert_name'],
            'expert_title' => $validated['expert_title'],
            'expert_followup' => $validated['expert_followup'],
    ...
    private function emptyClientForm(): array
    {
        ...
        return [
            ...
            'lead_capture_intro_message' => self::DEFAULT_LEAD_CAPTURE_INTRO_MESSAGE,
    ...
    private function transformClientForm(Client $client): array
    {
        ...
        return [
            ...
            'name' => $client->name,
            'contact_email' => $client->contact_email ?? '',
            'lead_capture_enabled' => (bool) $client->lead_capture_enabled,
            'lead_sms_enabled' => (bool) $client->lead_sms_enabled,
            'lead_sms_to' => $client->lead_sms_to ?? '',
            'website_url' => $client->website_url ?? '',
            'business_description' => $client->business_description ?? '',
            'system_prompt' => $client->system_prompt ?? '',
            'chatbot_tone' => $client->chatbot_tone ?? '',
            'engagement_questions' => $client->engagement_questions ?? '',
            'expert_name' => $client->expert_name ?? '',
            'expert_title' => $client->expert_title ?? '',
            'expert_followup' => $client->expert_followup ?? '',
