...
const statusMessage = computed(() => {
    ...
    if (props.status === 'plan-has-clients')
        return 'Cannot delete a plan that has clients assigned to it. Reassign clients first.';
    return null;
});
        ...
        <div class="p-4 md:p-6">
            ...
            <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                >
                    ...
                    <div
                        class="mb-4 space-y-2 rounded-lg bg-gray-50 p-3 dark:bg-gray-900/50"
                    >
                        ...
                        <div class="flex items-center justify-between text-sm">
                            ...
                            <span
                                class="font-medium text-gray-900 dark:text-gray-100"
                                >{{ plan.max_knowledge_sources }}</span
                            >
                        </div>
                        <div class="flex items-center justify-between text-sm">
                            <span class="text-gray-500 dark:text-gray-400"
                            ...
                            <span
                                class="font-medium text-gray-900 dark:text-gray-100"
                                >{{ plan.max_file_upload_mb }} MB</span
                            >
                        </div>
                    </div>
                    ...
                    >
                        ...
                        >
                            ...
                            {{ plan.clients_count }}
                            {{
                                plan.clients_count === 1 ? 'client' : 'clients'
                            }}
                        </span>
